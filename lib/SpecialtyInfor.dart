...
class SpecialtyInfor extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return SpecialtyInforState();
  }
}

class SpecialtyInforState extends State<SpecialtyInfor> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  _selectedDay('Thứ 2', isSelected1, 90),
                  _selectedDay('Thứ 3', isSelected2, 90),
                  _selectedDay('Thứ 4', isSelected3, 90),
                  _selectedDay('Thứ 5', isSelected4, 90),
                  _selectedDay('Thứ 6', isSelected5, 90),
                  _selectedDay('Thứ 7', isSelected6, 90),
                  _selectedDay('Chủ nhật', isSelected7, 49),
                  SizedBox(
