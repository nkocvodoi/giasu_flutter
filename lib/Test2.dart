...
import 'fetchData/List_ClassData.dart';
...
class _Lists_Class_State extends State<Test2> {
                      ...
                      return ListView.builder(
                        physics: NeverScrollableScrollPhysics(),
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return _buildBox(snapshot.data[index].id.toString());
                          });
