...
import 'package:test_giasu/UI_Main/TeacherListBox.dart';
...
class ClassDetailWithMoreTutorInfor extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return ClassDetailWithMoreTutorInforState(classData);
  }
}

class ClassDetailWithMoreTutorInforState extends State<ClassDetailWithMoreTutorInfor> {
  Data_class classData;
  ClassDetailWithMoreTutorInforState(this.classData);
