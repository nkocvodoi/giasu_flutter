...
Future<TeacherData> fetchTeacherData() async {
  final response = await http.get(
      'https://giasu.htcon.vn/api/v1/parents/tutors?page=1&search_tutor=%7B%22location_id%22:1%7D');
  Map<String, dynamic> mapResponse = json.decode(response.body);
  print(mapResponse["data"][0]["native_country"]);print('svgcsgcsg');
...
class TeacherData {
  ...
  factory TeacherData.fromJson(Map<String, dynamic> json) => TeacherData(
        ...
        data: (json['data'] as List)
            ?.map((e) => e == null
                ? null
                : Data_teacher.fromJson(e as Map<String, dynamic>))
            ?.toList(),
        status: json['status'],
        page: json['page'],
...
class Data_teacher {
  ...
  factory Data_teacher.fromJson(Map<String, dynamic> json) {
...
class Subject {
  ...
  String name;
  String group;
  Subject({this.id, this.name, this.group});
