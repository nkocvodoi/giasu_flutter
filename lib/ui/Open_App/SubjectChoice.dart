    ...
    return Scaffold(
                  ...
                  children: <Widget>[
                    ...
                    Column(
                      ...
                      children: <Widget>[
                        ...
                        _subjectChoice(model.subject[0], 30, model.subject[1],
                            30, model.subject[2], 30),
                        _subjectChoice(model.subject[3], 30, model.subject[4],
                            25, model.subject[5], 18),
                        _subjectChoice(model.subject[6], 25, model.subject[7],
                            27, model.subject[8], 25),
                        Row(
                          children: <Widget>[
                            Expanded(
                              flex: 1,
        ...
        bottomNavigationBar: Consumer<PersonalInforModel>(
          builder: (_, model, __) {
            ...
            //     Divider(thickness: 1),
                return Container(
                  padding: EdgeInsets.only(right: 20, left: 290),
