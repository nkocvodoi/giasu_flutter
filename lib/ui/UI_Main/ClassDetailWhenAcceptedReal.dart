...
class _ClassDetailRequestState extends State<ClassDetailWhenAccepted> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<PaymentModel>(builder: (_, model, __) {
      return Scaffold(
        appBar: AppBar(
          centerTitle: true,
...
//                        model.setMethod('Tài khoản coin');
                    int phinhanlop = model.phi_nhanlop(classData.class_fee, classData.tuition_fee, 3);
                    print(phinhanlop);
                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                Payments(phinhanlop, nophi, widget.classData)));
                  },
