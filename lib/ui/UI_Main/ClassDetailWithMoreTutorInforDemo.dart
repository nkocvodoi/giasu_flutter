...
class ClassDetailWithMoreTutorInforDemo extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _ClassDetailWithMoreTutorInforState();  }
  
}
 
class _ClassDetailWithMoreTutorInforState
    extends State<ClassDetailWithMoreTutorInforDemo> {
                        ...
                        Container(
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              _iconTextBox(
                                Text(
                                  'Số buổi/tuần: lesson_per_week (time_per_lesson h/buổi)',
                                  style: TextStyle(
                                    color: Colors.grey,
                                    fontSize:
                                        15,
                              ...
                              _iconTextBox(
                                Text(
                                  'Học phí/buổi: tuition_fee vnđ/2h',
                                  style: TextStyle(
                                    color: Colors.orange,
                                    fontSize:
                                        15,
