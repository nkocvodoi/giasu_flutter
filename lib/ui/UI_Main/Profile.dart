...
//    CurrentUser _user = Provider.of<ProfileModel>(context).autheticationService.currentUser;
//
...
//                          child: Expanded(
//                            child: Image.network(
//                                'https://giasu.htcon.vn' + _user.avatar),
//                          ),
//                        ),
//                      )
//                    ],
...
//                      _iconTextBoxNoBorder(
//                          Text(
//                            '${(_user.tuition_fee / 1000).toInt()},000 vnđ/buổi',
//                            style: TextStyle(
//                                color: Colors.red,
//                                fontSize: 15,
//                                fontStyle: FontStyle.normal,
