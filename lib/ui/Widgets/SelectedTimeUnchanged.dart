...
class SelectedTimeUnchanged extends StatelessWidget {
        ...
        if (snapshot.hasData) {
          ...
          return Padding(
            ...
            child: Column(
              children: <Widget>[
                _timeBox(
                    'Thứ 2', scheduleBool[1], scheduleBool[2], scheduleBool[3]),
                _timeBox(
                    'Thứ 3', scheduleBool[4], scheduleBool[5], scheduleBool[6]),
                _timeBox(
                    'Thứ 4', scheduleBool[7], scheduleBool[8], scheduleBool[9]),
                _timeBox('Thứ 5', scheduleBool[10], scheduleBool[11],
                    scheduleBool[12]),
                _timeBox('Thứ 6', scheduleBool[13], scheduleBool[14],
                    scheduleBool[15]),
                _timeBox('Thứ 7', scheduleBool[16], scheduleBool[17],
                    scheduleBool[18]),
                _timeBox('Chủ nhật', scheduleBool[19], scheduleBool[20],
                    scheduleBool[21]),
              ],
            ),
          );
